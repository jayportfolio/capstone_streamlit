# To run via terminal from project root:
#  cd capstone_submit/step_13/;python all_models_except_neural_networks.py;cd ../..
...
ALGORITHM_DETAIL = 'random search' # could be: 'custom' / 'rerun best'
...
if not using_catboost:
    if ALGORITHM_DETAIL == 'grid search' or ALGORITHM_DETAIL == 'grid search (implied)':
        ...
        results_for_best_results = get_results(directory='results/')
